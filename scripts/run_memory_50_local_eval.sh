...
# Run the local MasterAgent memory-only evaluation on the first N TVQA+ samples.
# VideoMemory is enabled; verifier and clip refiner are disabled.
...
RESULT_DIR="${RESULT_DIR:-$ROOT_DIR/results/local_memory_50}"
...
CHECKPOINT_PATH="${CHECKPOINT_PATH:-$RESULT_DIR/memory_${SAMPLE_LIMIT}.checkpoint.jsonl}"
LOG_FILE="${LOG_FILE:-$RESULT_DIR/memory_${SAMPLE_LIMIT}.log}"
...
echo "============================================================"
echo " LongVideoAgent Local Memory-Only Evaluation"
echo "============================================================"
